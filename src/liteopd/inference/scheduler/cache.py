...
from liteopd.inference.kvcache import BaseCacheHandle, MatchResult, create_prefix_cache
from liteopd.inference.utils import div_ceil
...
class CacheManager:
    ...
    def available_size(self) -> int:
        return self.prefix_cache.size_info.evictable_leaf_size + len(self.free_slots) * self.page_size
    ...
    def allocate_paged(self, reqs: List[Req]) -> bool:
        needed_pages = 0
    ...
    def _allocate(self, needed_pages: int) -> torch.Tensor | None:
