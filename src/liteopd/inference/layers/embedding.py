...
from liteopd.inference.distributed import DistributedCommunicator, get_tp_info
from liteopd.inference.utils import div_ceil, nvtx_annotate
...
class VocabParallelEmbedding(BaseOP):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        from liteopd.inference.kernel import indexing
