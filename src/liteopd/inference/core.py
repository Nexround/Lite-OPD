...
class Req:
    ...
    def __post_init__(self) -> None:
        ...
        self.max_device_len = len(self.input_ids) + self.max_output_len
    ...
    def decoded_len(self) -> int:
        """Number of output tokens already generated."""
        return self.max_output_len - self.remain_len
