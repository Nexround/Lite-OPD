...
if TYPE_CHECKING:
    from liteopd.inference.distributed import DistributedInfo
    from liteopd.inference.kernel import PyNCCLCommunicator
...
def enable_pynccl_distributed(
    ...
    if tp_info.size == 1:
        return
    from liteopd.inference.kernel import init_pynccl
