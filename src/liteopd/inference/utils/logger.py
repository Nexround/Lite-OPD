    ...
    *,
    ...
    class ColorFormatter(logging.Formatter):
        ...
        def format(self, record):
            from liteopd.inference.distributed import try_get_tp_info
...
def add_file_handler(logger, log_path: str) -> None:
    """Attach a plain-text file handler to an existing logger (no colors)."""
    import logging
