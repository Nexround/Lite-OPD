...
from liteopd.inference.utils import is_sm100_supported
...
class FlashAttentionBackend(BaseAttnBackend):
    ...
    def forward(
        ...
        w = self._sliding_window_sizes[layer_id]
        window_size = (w, 0) if w > 0 else (-1, -1)
        return _fa_sgl_impl(
            q=q,
